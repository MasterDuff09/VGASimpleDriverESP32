...
- (Built-in DAC used to get to required voltage levels for RGB signals) -- NOT USED


This project has been started for an University Project (Università La Sapienza Di Roma). It implements a bare VGA driver for an ESP32.
